...
HD_PWD='C:/Users/asus/Desktop/4.SINIF-1.DNEM/final_project4/final_project4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sorting_imp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sorting_imp_top.tcl -notrace
