...
HD_PWD='C:/Users/asus/Desktop/4.SINIF-1.DNEM/final_project4/final_project4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sorting_imp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sorting_imp_top.tcl
